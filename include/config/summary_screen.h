...
// IV/EV settings
#define P_SUMMARY_SCREEN_IV_EV_INFO      THREE_HORIZONS  // If TRUE, will allow player to cycle through the Stats, IVs, and EVs in the summary screen skills page.
...
#define P_SUMMARY_SCREEN_IV_EV_TILESET   THREE_HORIZONS  // If TRUE, loads an alternate tileset to allow changing the "STATS" label in the summary screen skills page. Note: if it's still loading the alternate tileset after changing this and recompiling, you may need a `make clean` before compilation.
#define P_SUMMARY_SCREEN_IV_EV_VALUES    THREE_HORIZONS  // If TRUE, will show the actual IV value instead of the letter grade.
/*
LETTER GRADE GUIDE:
