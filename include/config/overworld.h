...
// Follower Pokémon
#define OW_FOLLOWERS_ENABLED           THREE_HORIZONS      // Enables follower Pokémon, HGSS style. Requires OW_POKEMON_OBJECT_EVENTS. Note that additional scripting may be required for them to be fully supported!
