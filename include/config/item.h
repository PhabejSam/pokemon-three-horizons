...
// TM config
#define I_REUSABLE_TMS          THREE_HORIZONS       // In Gens5-8, TMs are reusable. Setting this to TRUE will make all vanilla TMs reusable, though they can also be cherry-picked by setting their importance to 1.
